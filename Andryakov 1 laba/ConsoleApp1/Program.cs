...
class Program
{
    ...
    {
        var Person1 = new Person("Andryakov", "Matvey", DateTime.Now);
        var Person2 = new Person("Kirill", "Botikov", DateTime.Now);

        var date1 = DateTime.Now;
        var date2 = new DateTime(2004, 6, 13);
        ...
        student.AddExams(new Exam("algebra", 3, date1), new Exam("geometry", 5, date2));

        student2.AddExams(new Exam("geography", 5, date1), new Exam("chemistry", 5, date2));
